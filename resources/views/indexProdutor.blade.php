            ...
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <div class="navbar-header">
                <!-- Navbar Brand --><a href="index.html" class="navbar-brand d-none d-sm-inline-block">
                  <div class="brand-text d-none d-lg-inline-block"><span>Perfil </span><strong>Produtor</strong></div>
      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
                    <li class="active"><a href="index.html"> <i class="icon-home"></i>Página principal </a></li>
                    <li><a href="/tables"> <i class="icon-grid"></i>Lista de produtos</a></li>
                    <li><a href="/tables"> <i class="icon-grid"></i>Adicionar produtos</a></li>
                    <li><a href="/chartsProdutor"> <i class="fa fa-bar-chart"></i>Gráficos de assinaturas</a></li>
              ...
              <div class="row bg-white has-shadow">
                ...
                <div class="col-xl-3 col-sm-6">
                  <div class="item d-flex align-items-center">
                    ...
                    <div class="title"><span>Pedidos de<br>Assinaturas</span>
                      <div class="progress">
                ...
                <div class="col-xl-3 col-sm-6">
                  <div class="item d-flex align-items-center">
                    ...
                    <div class="title"><span>Novas<br>Mensagens</span>
                      <div class="progress">
                ...
                <div class="col-xl-3 col-sm-6">
                  <div class="item d-flex align-items-center">
                    ...
                    <div class="title"><span>Novas<br>Avaliações</span>
                      <div class="progress">
